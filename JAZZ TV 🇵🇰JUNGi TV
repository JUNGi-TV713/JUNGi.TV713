<script src="http://portal.ncnd.jazz.com.pk/ncnd/public/js/jquery-3.5.1.min.js"></script>
<title>JUNGi TV Developement Jazz TV</title>
<style type="text/css">
  $font: 'Poppins',
  sans-serif;
  }
  ...
  iframe {
    width: 100%;
    height: 250px;
    -webkit-box-shadow: 0px 10px 13px -7px #000000, 5px 5px 17px -1px rgba(255, 255, 255, 0);
    box-shadow: 0px 10px 13px -7px #000000, 5px 5px 17px -1px rgba(255, 255, 255, 0);
  }
  ...
  body {
    ...
    margin-right: 0px;
    margin-left: 0px;
    padding: 0 background: rgb(255, 0, 238);
    background: linear-gradient(90deg, rgba(000, 0, 006, 6) 0%, rgba(000, 0, 6, 6) 100%);
  }
...
<input name="8xm" type="image" autofocus class="Button" id="" src="https://srv2.jazztv.pk/jazzlive/uploads/channels/8xm-Logo.png"onclick="song()" />
              ...
              <input name=" seetv " type="image" autofocus class="Button" id=" dunyatv " src="  https://srv2.jazztv.pk/jazzlive/uploads/categories/a/SEE-Tv.png  " onclick="seetv()"/>
